...
String input; // ajout pour lire les commande
void setup() {
...
if (Serial.available())
{
  ...
  switch (temp)
  {
    ...
    Serial.println(F("ACK CMD set RAW format. END"));
    break;
    case 0x13: 
    temp = 0xff;
    read_image_RAW(myCAM);
    break;
    case 0x20:
    mode = 2;
    temp = 0xff;
...
void read_image_RAW(ArduCAM myCAM){
